                 ...
                 Row(
                   ...
                   children: [
                     ElevatedButton(
                      onPressed:  
                        ()  {
                          //citaService.rechazarCita(widget.cita.idCita,widget.cita.paciente.id_paciente);

                          final route = MaterialPageRoute(
                            builder: (context) => ResultadoAceptarRechazarCita(resultado: 'CITA RECHAZADA',));
                      ...
                      onPressed:  
                        ()  {
                          //citaService.aceptarCita(widget.cita.idCita,widget.cita.paciente.id_paciente);
                          final route = MaterialPageRoute(
                            builder: (context) => ResultadoAceptarRechazarCita(resultado: 'CITA ACEPTADA',));
                        //VALIDAR SI LA SOLICITUD DE LA CITA ES VALIDA
                        Navigator.pushAndRemoveUntil(
                            context, route, (route) => false);
                      } , 
